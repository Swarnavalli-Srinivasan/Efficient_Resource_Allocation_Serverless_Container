...
public class DeepRLHelper {
    ...
    public static List<DRLCloudlet> createCloudletListBitBrain(int brokerId, String inputFolderName)
        ...
        Log.printLine("@ " + PEBFDLRRunner.class.getSimpleName() + " inputFolder: " + inputFolderName);
        UtilizationModel utilizationModelNull = new UtilizationModelNull();

        File inputFolder = new File(inputFolderName);
        File[] files = inputFolder.listFiles();
        Log.printLine("@ " + PEBFDLRRunner.class.getSimpleName() + " inputFolder: " + inputFolder + " Number of files: " + files.length);
    ...
    public static List<DRLCloudlet> createCloudletListBitBrainDynamic(int brokerId, String inputFolderName, int delay)
        ...
        File inputFolder = new File("D:\\swarna\\cloudsim\\DLSF\\CloudSim\\modules\\cloudsim-examples\\src\\main\\java\\workload\\bitbrain\\fastStorage\\2013-8");
        Log.printLine("@ " + PEBFDLRRunner.class.getSimpleName() + " inputFolder: " +  (inputFolder));
