...
/**
 * A Container allocation policy that uses Local Regression (LR) to predict host utilization (load)
 ...
 * </ul>
 *
 * @author Swaranvalli Srinivasan
 * @since CloudSim Toolkit 3.0
 */
public class PowerContainerAllocationPolicyMigrationPEBFDLocalRegression extends PowerVmAllocationPolicyPEBFDMigrationAbstract {
     ...
     * data to be computed. */
    private PowerVmAllocationPolicyPEBFDMigrationAbstract fallbackVmAllocationPolicy;
     ...
     */
    public PowerContainerAllocationPolicyMigrationPEBFDLocalRegression(
            List<? extends Host> hostList,
            PowerVmSelectionPolicy vmSelectionPolicy,
            double safetyParameter,
            double schedulingInterval,
            PowerVmAllocationPolicyPEBFDMigrationAbstract fallbackVmAllocationPolicy,
     ...
     */
    public PowerVmAllocationPolicyPEBFDMigrationAbstract getFallbackVmAllocationPolicy() {
